...
int ReloadSongsByQuery(CSTR query, sqlite3 * sql, CONFIG_JUKEBOX * jb, ReloadProgress progress = ReloadProgress::None, double reloadStartedAt = -1.0); //check reload condition and run
